...
namespace Project
{
    public partial class TrainerCreateWPSun : Form
    {
        private int trainerid, wid;
        public TrainerCreateWPSun(int trainerid, int wid)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into workoutday values (@idd, 'Sunday', @o, @N)";
            ...
            MessageBox.Show("Sunday Exercise Decided!");
        }

        private void TrainerCreateWPSun_Load(object sender, EventArgs e)
        {
