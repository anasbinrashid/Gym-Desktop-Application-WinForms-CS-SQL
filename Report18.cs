...
namespace Project
{
    public partial class Report18 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from member where member.gender like 'Female'", conn);
            ...
            reportViewer1.LocalReport.ReportPath = @"D:\ANAS\WORK\SEMESTER 4\Database Systems\Project\Project\Project\Report18.rdlc";
