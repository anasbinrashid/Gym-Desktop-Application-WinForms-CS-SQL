...
namespace Project
{
    public partial class TrainerCreateDPDinner : Form
    {
        private int trainerid, did;
        public TrainerCreateDPDinner(int trainerid, int did)
        {
            InitializeComponent();
        ...
        {
            this.Close();
            Trainer_Creates_DP trainer_Creates_DP = new Trainer_Creates_DP(trainerid);
            trainer_Creates_DP.Show();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into meal values (@idd, @o, @N, @dt, @t, @m, @c, @p, @ps, 'Dinner', @did)";
            ...
            MessageBox.Show("Dinner Decided!");
        }

        private void TrainerCreateDPDinner_Load(object sender, EventArgs e)
        {
