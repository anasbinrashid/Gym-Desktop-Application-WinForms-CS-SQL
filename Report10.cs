...
namespace Project
{
    public partial class Report10 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Gyms_TotalMembers", conn);
            ...
            reportViewer1.LocalReport.ReportPath = @"D:\ANAS\WORK\SEMESTER 4\Database Systems\Project\Project\Project\Report10.rdlc";
