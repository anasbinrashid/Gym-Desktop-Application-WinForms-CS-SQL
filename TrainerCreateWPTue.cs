...
namespace Project
{
    public partial class TrainerCreateWPTue : Form
    {
        private int trainerid, wid;
        public TrainerCreateWPTue(int trainerid, int wid)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into workoutday values (@idd, 'Tuesday', @o, @N)";
            ...
            MessageBox.Show("Tuesday Exercise Decided!");
        }

        private void TrainerCreateWPTue_Load(object sender, EventArgs e)
        {
