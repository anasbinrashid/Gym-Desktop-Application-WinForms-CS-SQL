...
namespace Project
{
    public partial class TrainerCreateWPSat : Form
    {
        private int trainerid, wid;
        public TrainerCreateWPSat(int trainerid, int wid)
        {
            InitializeComponent();
        ...
        private void TrainerCreateWPSat_Load(object sender, EventArgs e)
        {
