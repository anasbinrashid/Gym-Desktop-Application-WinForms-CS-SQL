...
namespace Project
{
    public partial class TrainerCreateDPBreakfast : Form
    {
        private int trainerid, did;
        public TrainerCreateDPBreakfast(int trainerid, int did)
        {
            InitializeComponent();
        ...
        private void TrainerCreateDPBreakfast_Load(object sender, EventArgs e)
        {
