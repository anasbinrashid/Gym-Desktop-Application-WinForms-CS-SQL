...
namespace Project
{
    public partial class MemberCreateWPThurs : Form
    {
        private int memberid, wid;
        public MemberCreateWPThurs(int memberid, int wid)
        {
            InitializeComponent();
        ...
        private void MemberCreateWPThurs_Load(object sender, EventArgs e)
        {
