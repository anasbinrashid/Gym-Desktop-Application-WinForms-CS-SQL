...
namespace Project
{
    public partial class Report20 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from trainer where trainer.experience>7", conn);
            ...
            reportViewer1.LocalReport.ReportPath = @"D:\ANAS\WORK\SEMESTER 4\Database Systems\Project\Project\Project\Report19.rdlc";
