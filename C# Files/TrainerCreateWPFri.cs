...
namespace Project
{
    public partial class TrainerCreateWPFri : Form
    {
        private int trainerid, wid;
        public TrainerCreateWPFri(int trainerid, int wid)
        {
            InitializeComponent();
        ...
        {
            this.Close();
            Trainer_Creates_WP trainer_Creates_WP = new Trainer_Creates_WP(trainerid);
            trainer_Creates_WP.Show();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into workoutday values (@idd, 'Friday', @o, @N)";
            ...
            MessageBox.Show("Friday Exercise Decided!");
        }

        private void TrainerCreateWPFri_Load(object sender, EventArgs e)
        {
