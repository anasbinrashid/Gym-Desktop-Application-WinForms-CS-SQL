...
namespace Project
{
    public partial class MemberCreatesDPDinner : Form
    {
        private int memberid, did;
        public MemberCreatesDPDinner(int memberid, int did)
        {
            InitializeComponent();
        ...
        private void MemberCreatesDPDinner_Load(object sender, EventArgs e)
        {
