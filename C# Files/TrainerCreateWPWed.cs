...
namespace Project
{
    public partial class TrainerCreateWPWed : Form
    {
        private int trainerid, wid;
        public TrainerCreateWPWed(int trainerid, int wid)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into workoutday values (@idd, 'Wednesday', @o, @N)";
            ...
            MessageBox.Show("Wednesday Exercise Decided!");
        }

        private void TrainerCreateWPWed_Load(object sender, EventArgs e)
        {
