...
namespace Project
{
    public partial class TrainerCreateWPThurs : Form
    {
        private int trainerid, wid;
        public TrainerCreateWPThurs(int trainerid, int wid)
        {
            InitializeComponent();
        ...
        private void TrainerCreateWPThurs_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into workoutday values (@idd, 'Thursday', @o, @N)";
            ...
            MessageBox.Show("Thursday Exercise Decided!");
        }
    }
}
