...
namespace Project
{
    public partial class MemberChooseUserWP : Form
    {
        private int memberid;
        public MemberChooseUserWP(int memberid)
        {
            InitializeComponent();
            this.memberid = memberid;
        }

        private void MemberChooseUserWP_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dbprojectDataSet58.workoutplan' table. You can move, or remove it, as needed.
            this.workoutplanTableAdapter4.Fill(this.dbprojectDataSet58.workoutplan);
            // TODO: This line of code loads data into the 'dbprojectDataSet29.workoutplan' table. You can move, or remove it, as needed.
            //this.workoutplanTableAdapter3.Fill(this.dbprojectDataSet29.workoutplan);
            // TODO: This line of code loads data into the 'dbprojectDataSet28.workoutplan' table. You can move, or remove it, as needed.
            //this.workoutplanTableAdapter2.Fill(this.dbprojectDataSet28.workoutplan);
            //// TODO: This line of code loads data into the 'dbprojectDataSet16.workoutplan' table. You can move, or remove it, as needed.
            //this.workoutplanTableAdapter1.Fill(this.dbprojectDataSet16.workoutplan);
            //// TODO: This line of code loads data into the 'dbprojectDataSet8.workoutplan' table. You can move, or remove it, as needed.
        ...
        private void gridbind()
        {
            ...
            using (SqlConnection con = new SqlConnection(conn))
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from workoutplan where createdby = 'Member'", con);
