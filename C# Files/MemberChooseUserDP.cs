...
namespace Project
{
    public partial class MemberChooseUserDP : Form
    {
        private int memberid;
        public MemberChooseUserDP(int memberid)
        {
            InitializeComponent();
            this.memberid = memberid;
        }

        private void MemberChooseUserDP_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dbprojectDataSet57.dietplan' table. You can move, or remove it, as needed.
            this.dietplanTableAdapter4.Fill(this.dbprojectDataSet57.dietplan);
            // TODO: This line of code loads data into the 'dbprojectDataSet26.dietplan' table. You can move, or remove it, as needed.
            //this.dietplanTableAdapter3.Fill(this.dbprojectDataSet26.dietplan);
            // TODO: This line of code loads data into the 'dbprojectDataSet15.dietplan' table. You can move, or remove it, as needed.
            //this.dietplanTableAdapter2.Fill(this.dbprojectDataSet15.dietplan);
            // TODO: This line of code loads data into the 'dbprojectDataSet14.dietplan' table. You can move, or remove it, as needed.
            //this.dietplanTableAdapter1.Fill(this.dbprojectDataSet14.dietplan);
            // TODO: This line of code loads data into the 'dbprojectDataSet6.dietplan' table. You can move, or remove it, as needed.
            //this.dietplanTableAdapter.Fill(this.dbprojectDataSet6.dietplan);
        ...
        private void gridbind()
        {
            ...
            using (SqlConnection con = new SqlConnection(conn))
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from dietplan where createdby = 'Member'", con);
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.dietplanTableAdapter1.FillBy(this.dbprojectDataSet14.dietplan);
            }
        ...
        private void fillByToolStripButton1_Click(object sender, EventArgs e)
        {
            try
            {
                this.dietplanTableAdapter2.FillBy(this.dbprojectDataSet15.dietplan);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillBy1ToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.dietplanTableAdapter2.FillBy1(this.dbprojectDataSet15.dietplan);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillBy2ToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.dietplanTableAdapter2.FillBy2(this.dbprojectDataSet15.dietplan);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        {
            this.dietplanBindingSource4.Filter = this.advancedDataGridView1.FilterString;
        }

        private void advancedDataGridView1_SortStringChanged(object sender, EventArgs e)
        {
            this.dietplanBindingSource4.Sort = this.advancedDataGridView1.SortString;
