...
namespace Project
{
    public partial class MemberCreatesDPLunch : Form
    {
        private int memberid, did;
        public MemberCreatesDPLunch(int memberid, int did)
        {
            InitializeComponent();
        ...
        private void MemberCreatesDPLunch_Load(object sender, EventArgs e)
        {
